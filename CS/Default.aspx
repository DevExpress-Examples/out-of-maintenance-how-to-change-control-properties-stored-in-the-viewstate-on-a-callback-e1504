<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ControlPropertiesChangeOnCallback._Default" %>

<%@ Register Assembly="DevExpress.Web.v13.2" Namespace="DevExpress.Web" TagPrefix="dxp" %>
<%@ Register Assembly="DevExpress.Web.v13.2" Namespace="DevExpress.Web" TagPrefix="dxcp" %>
<%@ Register Assembly="DevExpress.Web.v13.2" Namespace="DevExpress.Web" TagPrefix="dxhf" %>
<%@ Register Assembly="DevExpress.Web.v13.2" Namespace="DevExpress.Web" TagPrefix="dxe" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function SetButtonBorderColor(button, borderColor) {
            button.GetMainElement().style.borderColor = borderColor;
...
<body>
    ...
    <div>
                ...
                <dxp:PanelContent runat="server">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <dxe:ASPxButton ID="btnChangePropertiesOnCallback" runat="server" AutoPostBack="False"
                                    UseSubmitBehavior="False" Text="On Callback" EncodeHtml="False" Width="130px">
                                    <ClientSideEvents Click="OnChangePropertiesOnCallback" />
                                </dxe:ASPxButton>
                            </td>
                            <td>
                                <dxe:ASPxButton ID="btnChangePropertiesOnClient" runat="server" AutoPostBack="False"
                                    UseSubmitBehavior="False" Text="On Client" EncodeHtml="False" Width="130px">
                        ...
                        <tr>
                            ...
                            <td>
                                <dxe:ASPxButton ID="btnDoPostback" runat="server" Text="Via Postback" EncodeHtml="False"
                                    Width="130px" />
                            </td>
                        </tr>
                    </table>
        ...
        <p style="margin-top: 35px;">
            ...
            properties of the test ASPxButton control either on the server via a callback or
            on the client. Then, you can update the page via a postback or update a part of
            the page that contains the test button via a callback. The customized ASPxButton
            doesn't lose its appearance during these updates, which always happens when you
            change some view-state-stored properties on a callback. Such a result is achieved
            by storing the Text and BorderColor properties in an external ASPxHiddenField.
        </p>
        <%-- EndRegion --%>
